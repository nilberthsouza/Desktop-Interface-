...
class Database:
    def __init__(self, db):
        ...
        self.cur.execute("CREATE TABLE IF NOT EXISTS parts (id INTENGER PRIMARY KEY, part text,customer text, retailer text, price text)")
        self.conn.commit()
    def fetch(self):
...
#db.insert("24 inch Samsung Monitor","Sam Smith","BestBuy","180")
